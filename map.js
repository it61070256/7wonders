...
var color3 = chart.colors.getIndex(9);
...
polygonTemplate.events.on("hit", function (ev) {
  ...
  chart.openPopup("This is <strong>" + ev.target.dataItem.dataContext.name + "</strong>");
});
...
pin.background.fill = chart.colors.getIndex(9);
...
function changePin(mode) {
  if (mode == 1) {
    document.getElementById("bc").style.backgroundColor = "#67dc75"
    document.getElementById("bc1").style.backgroundColor = "#67dc75"
    document.getElementById("bc2").style.backgroundColor = "#67dc75"
    document.getElementById("bc3").style.backgroundColor = "#67dc75"
    document.getElementById("bc4").style.backgroundColor = "#67dc75"
    document.getElementById("bc5").style.backgroundColor = "#67dc75"
    document.getElementById("bc6").style.backgroundColor = "#67dc75"
    console.log("selected 1 ")
    var shadow = polygonSeries.filters.push(new am4core.DropShadowFilter());
    shadow.color = am4core.color("#00ff26");
    shadow.blur = 0;
    pin.background.fill = chart.colors.getIndex(16);
    ...
    imageSeries.data = [
      {
        ...
        text: "เจ็ดสิ่งมหัศจรรย์ที่เก่าแก่ที่สุด"
      },
      {
        latitude: 33.569219,
        longitude: 45.127161,
        ...
        text: "หนึ่งในสวนลอยที่งดงามที่สุด"
      },
      {
        latitude: 37.9493643,
      ...
      },
      {
        ...
        text: "รูปปั้นของผู้ปกครองแห่งโอลิมปัส"
      },
      {
        latitude: 37.0378917,
      ...
      },
      {
        ...
        text: "รูปปั้นของอพอลโล เทพแห่งดวงอาทิตย์"
      },
      {
        latitude: 31.2243285,
        ...
        text: "ประภาคารแห่งเมืองอเล็กซานเดรีย"
      },
    ];
  }
  else if (mode == 2) {
    document.getElementById("bc").style.backgroundColor = "#6794dc"
    document.getElementById("bc1").style.backgroundColor = "#6794dc"
    document.getElementById("bc2").style.backgroundColor = "#6794dc"
    document.getElementById("bc3").style.backgroundColor = "#6794dc"
    document.getElementById("bc4").style.backgroundColor = "#6794dc"
    document.getElementById("bc5").style.backgroundColor = "#6794dc"
    document.getElementById("bc6").style.backgroundColor = "#6794dc"
    console.log("selected 2 ")
    var shadow = polygonSeries.filters.push(new am4core.DropShadowFilter());
    shadow.color = am4core.color("#005ef5");
    shadow.blur = 0;
    pin.background.fill = chart.colors.getIndex(1);
    var thisAge = document.getElementById("thisAge");
    ...
    imageSeries.data = [
      {
        ...
        text: "หนึ่งในสุสานอีกแบบของกษัตริย์ฟาโรห์"
      },
      {
        latitude: 51.1778865,
        longitude: -1.8279531,
        ...
        text: "หินปริศนาที่ยังไม่มีคำตอบ"
      },
      {
        latitude: 32.0093905,
        ...
        text: "เจดีย์กระเบื้องที่วิจิตรแห่งเมืองนานกิง"
      },
      {
        latitude: 41.008587,
        ...
        text: "โบสถ์ทรงโดมที่ขนาดใหญ่ที่สุด"
      },
      {
        latitude: 43.7229559,
      ...
      },
      {
        ...
        text: "สนามกีฬากลางแจ้งที่ขนาดใหญ่ที่สุด"
      },
      {
        latitude: 40.4319118,
        ...
        text: "กำแพงที่ยาวที่สุดในโลก"
      },
    ];
  }
  else {
    document.getElementById("bc").style.backgroundColor = "#dc6967"
    document.getElementById("bc1").style.backgroundColor = "#dc6967"
    document.getElementById("bc2").style.backgroundColor = "#dc6967"
    document.getElementById("bc3").style.backgroundColor = "#dc6967"
    document.getElementById("bc4").style.backgroundColor = "#dc6967"
    document.getElementById("bc5").style.backgroundColor = "#dc6967"
    document.getElementById("bc6").style.backgroundColor = "#dc6967"
    ...
    wonder4.innerHTML = "Great Wall of China";
    ...
    imageSeries.data = [
      ...
      },
      {
        ...
        text: "รูปปั้นพระเยซูที่ใหญ่ที่สุด"
      },
      {
        latitude: -13.163136,
      ...
      },
      {
        ...
        text: "นครหินที่มาจากการแกะโบราณ"
      },
      {
        latitude: 23.2341868,
        longitude: 80.331867,
    ...
    pin.events.on("hit", function (ev) {
        ...
        setTimeout(function() {
          ...
          var popup = chart.openPopup("<img src= "+ev.target.dataItem.dataContext.flag +"></img>"+ "<br>" +ev.target.dataItem.dataContext.text);
